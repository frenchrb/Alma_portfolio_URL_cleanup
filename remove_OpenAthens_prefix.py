...
def worker():
    while True:
        ...
        if get_response.status_code == 200:
            ...
            output.append((port['row'], existing_url_col_index, static_url))
            
            if 'https://go.openathens.net/redirector/jmu.edu?url=' in static_url:
                new_url = static_url.replace('https://go.openathens.net/redirector/jmu.edu?url=', '')
